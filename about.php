...
<body>
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            ...
            <div class="our-story">
              ...
              <ul>
                <li><i class="bi bi-check-circle"></i> <span>Получите бесплатные консультации ответственных и опытных врачей!</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Оставьте своих детей, которые являются смыслом вашей жизни, в надежных руках!</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Клиника с современными условиями!</span></li>
              </ul>
              <p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="999" data-purecounter-duration="60" class="purecounter"></span>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="57" data-purecounter-duration="15" class="purecounter"></span>
                <p>Услуг</p>
              </div>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="689" data-purecounter-duration="60" class="purecounter"></span>
                <p>Часы поддержки</p>
              </div>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="13" data-purecounter-duration="5" class="purecounter"></span>
                <p>Врачи</p>
              </div>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
              ...
              <div>
                ...
                <p>Эвомед — это круглосуточная детская клиника с квалифицированными врачами.</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                ...
                <p>Детская клиника в центре города</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                ...
                <p>Квалифицированные врачи – залог безопасности</p>
              </div>
            </div><!-- End Icon Box -->
          </div>
        </div>
        ...
        <div class="row gy-5">
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
            <div class="member-img">
              <img src="assets/img/hero-carousel/img/doctor1.jpg" class="img-fluid" alt="rasm">
            </div>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
            <div class="member-img">
              <img src="assets/img/hero-carousel/img/doctor5.jpg" class="img-fluid" alt="rasm">
            </div>
            <div class="member-info text-center">
              <h4>Ядгарова Дилнура Уткуровна</h4>
              <p>Педиатр-неонатолог</p>
            </div>
          </div><!-- End Team Member -->
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="assets/img/hero-carousel/img/doctor2.jpg" class="img-fluid" alt="rasm">
            </div>
            <div class="member-info text-center">
          ...
          <!-- <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="member-info text-center">
              <h4>Турабаева Феруза Корабаевна</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              <img src="assets/img/hero-carousel/img/doctor.jpg" class="img-fluid" alt="rasm">
            </div>
            <div class="member-info text-center">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="500">
            <div class="member-img">
              <img src="assets/img/hero-carousel/img/doctor4.jpg" class="img-fluid" alt="rasm">
            </div>
            <div class="member-info text-center">
          ...
          <!-- <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            <div class="member-img">
              <img src="assets/img/hero-carousel/img/doctor3.jpg" class="img-fluid" alt="rasm">
            </div>
            <div class="member-info text-center">
              <h4>Мадаминова Нилуфар Рустамбаевна</h4>
              <p>Педиатр</p>
            </div>
          </div> -->
          <!-- End Team Member -->
          ...
          <!-- <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="member-info text-center">
              <h4>Чориев Жамшид Фарходович</h4>
              <p>Педиатр</p>
            </div>
          </div> -->
          <!-- End Team Member -->
          ...
          <!-- <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="member-info text-center">
              <h4>Норбутаев Маьруф Фарходович</h4>
              <p>Педиатр</p>
            </div>
          </div> -->
          <!-- End Team Member -->
          ...
          <!-- <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="member-info text-center">
              <h4>Ниёзкулов Достон Усмонович</h4>
              <p>Педиатр</p>
            </div>
          </div> -->
          <!-- End Team Member -->
          ...
          <!-- <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="member-info text-center">
              <h4>Хидоев Улугбек  Нажмиддинович</h4>
              <p>Педиатр</p>
            </div>
          </div> -->
          <!-- End Team Member -->
  ...
  <a href="tel:+998 55 500 3200" class="scroll-top d-flex align-items-center justify-content-center"><i class="bi bi-telephone-outbound-fill"></i></a>
