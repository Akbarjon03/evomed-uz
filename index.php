...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Evomed bolalar klinikasi">
    <meta property="og:description" content="Evomed bolalar klinikasi , Pediatr, Nevropatolog, Ortoped, Logoped, Bolalar psixologi, Massaj, Fizioterapiya, EEG, Laboratoriya">
    <meta property="og:image" content="https://evomed.uz/images/logo.png">
    <meta property="og:url" content="https://evomed.uz/">
    <meta property="og:type" content="website">
    <link rel="canonical" href="https://evomed.uz/"/>
      ...
      >
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a href="./uz/index.php">Узбекский язык</a></li>
          </ul>
        </nav>
        <!-- .navbar -->
      </div>
                ...
                <div class="row gy-4">
                  ...
                  >
                    <div class="service-item position-relative">
                      ...
                      <h3>Педиатр</h3>
                      <p>
                        Врач, который дает оценку физическому и нервно-психическому развитию детей, занимается профилактикой и лечением целого ряда заболеваний.
                      </p>
                  ...
                  >
                    <div class="service-item position-relative">
                      ...
                      <h3>Ортопед</h3>
                      <p>
                        Врач, специализирующийся на диагностике и лечении при проблемах позвоночника, плоскостопие, сколиозы и т.д.
                      </p>
                      <a href="./services.php" class="readmore stretched-link"
                        >Узнать больше <i class="bi bi-arrow-right"></i
                      ></a>
                  ...
                  >
                    <div class="service-item position-relative">
                      ...
                      <h3>Детский массаж</h3>
                      <p>
                        Один из самых эффективных способов лечения многих заболеваний, возничкающих на первых годах жизни ребенка.
                      </p>
                      <a href="./services.php" class="readmore stretched-link"
                        >Узнать больше <i class="bi bi-arrow-right"></i
                      ></a>
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(assets/img/hero-carousel/img/doctor1.jpg);
                      "
                    ></div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-7 d-flex align-items-center">
                    <div class="card-body">
                      ...
                      <p>
                        Детский невропатолог, заведующая отделения неврологии
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(assets/img/hero-carousel/img/doctor2.jpg);
                      "
                    ></div>
                  </div>
                  <div class="col-xl-7 d-flex align-items-center">
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(assets/img/hero-carousel/img/doctor5.jpg);
                      "
                    ></div>
                  </div>
                  <div class="col-xl-7 d-flex align-items-center">
        ...
        <div class="row justify-content-between gy-4">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up">
            <div class="content">
              ...
              <p>Быстрый контакт с Evomed! Мы готовы помочь вам 24/7. Бесплатная консультация и все виды детской медицинской помощи</p>
            </div>
          </div>
          ...
          <div class="col-lg-5" data-aos="fade">
            <form method="POST" action="./cntact.php" role="form" >
              <div class="row gy-4">
                ...
                <div class="col-lg-6 form-group">
                  <input type="text" id="phone" class="form-control" placeholder="Ваше номер телефона" name="phone" required><br>
                </div>
              </div>
